...
public:
  ...
  MvrTransform(MvrPose pose) { setTransform(pose); }
  /// Constructor, sets the transform so that pose1 will be
  /// transformed to pose2
  MvrTransform(MvrPose pose1, MvrPose pose2) { setTransform(pose1, pose2); }
  /// Destructor
