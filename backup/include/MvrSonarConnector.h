/**************************************************************************************************
 ...
 > Description  : Connect to sonar based on robot parameters and command-line arguments
 > Author       : Yu Jie
...
public:
  ...
  MVREXPORT MvrSonarConnector(MvrArgumentParser *parser, 
  ...
  MVREXPORT bool connectSonars(bool continueOnFailedConnect = false,
	...
	MVREXPORT bool connectReplaySonars(bool continueOnFailedConnect = false,
			                               bool addConnectedSonarsToRobot = true,
			                               bool addAllSonarsToRobot = false,
			                               bool turnOnSonars = true,
			                               bool powerCycleSonarOnFailedConnect = true);
  /// Sets up a sonar to be connected
  MVREXPORT bool setupSonar(MvrSonarMTX *sonar, int sonarNumber = 1);
  ...
  MVREXPORT bool addSonar(MvrSonarMTX *sonar,int sonarNumber = 1);
