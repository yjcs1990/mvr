...
*/
MVREXPORT MvrGripper::MvrGripper(MvrRobot *robot, int gripperType) :
  myConnectCB(this, &MvrGripper::connectHandler),
  myPacketHandlerCB(this, &MvrGripper::packetHandler)
{
  myRobot = robot;
  myType = gripperType;
  if (myRobot != NULL) 
