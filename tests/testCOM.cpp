...
//not all standard baud rates are supported, "MvrSerialConnection::rateToBaud" supports these:
  bauds[0] = 300;
  bauds[1] = 1200;
  bauds[2] = 1800;
  bauds[3] = 2400;
...
exit(0);
  ...
  MvrSerialConnection ser1;
  MvrSerialConnection ser2;
  ...
  switch(c1)
    ...
    case '2':
      ...
      break;
    case '3':
      ser1.setPort("/dev/ttyUSB2");
      break;
    default:
      ser1.setPort("/dev/ttyUSB3");
      break;
    }
  MvrUtil::sleep(50);
  switch(c2)
...
void sleep(int br)
{
MvrUtil::sleep((200000 / (long)br) + 2);
//MvrUtil::sleep(2);
return;
}
