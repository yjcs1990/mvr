...
public: 
  ...
  **/
   ...
   * on a ForbiddenMvrea but not a ForbiddenLine.)
   *
  **/
   ...
   * Note that this function doesn't know whether it actually makes sense 
   * for this map object to have the rotation.  (For example, it makes sense
   * on a ForbiddenMvrea but not a ForbiddenLine.)  This is just here so
  ...
  **/
   ...
   * ForbiddenLine but not a ForbiddenMvra.)  This is just here to
