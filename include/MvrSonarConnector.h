...
public:
  ...
  MVREXPORT MvrLaserConnector(MvrArgumentParser *parser, 
...
protected:
  ...
  MVREXPORT bool parseLaserArgs(MvrArgumentParser *parser, LaserData *laserData);
