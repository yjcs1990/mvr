...
class ArPyFunctor : public virtual MvrFunctor 
{
protected:
  PyObject* pyFunction;
public:
...
{
public:
  ArPyRetFunctor_Bool(PyObject* _m) : MvrRetFunctor<bool>(), ArPyFunctor(_m) {
  }
...
{
public:
  ArPyFunctor1_String(PyObject* _m) : MvrFunctor1<const char*>(), ArPyFunctor(_m) {
  }
...
{
public:
  ArPyPacketHandlerFunctor(PyObject* _m) : MvrRetFunctor1<bool, MvrRobotPacket*>(), ArPyFunctor(_m) {}
...
{
public:
  ArPyFunctor1(PyObject* pyfunc) : MvrFunctor1<T1>(), ArPyFunctor(pyfunc) {
  }
...
{
public:
  ArPyFunctor2(PyObject* _m) : MvrFunctor2<T1, T2>(), ArPyFunctor(_m) {
  }
