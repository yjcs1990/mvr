...
public:
  ...
  MVREXPORT void invalidateReading(std::list<ArPoseWithTime*>::iterator readingIt);
   ...
   *  @swigomit
   */
  MVREXPORT const std::list<ArPoseWithTime *> *getBuffer(void) const;
#endif
  /// Gets a pointer to a list of readings
  MVREXPORT std::list<ArPoseWithTime *> *getBuffer(void);
  ...
  MVREXPORT std::vector<ArPoseWithTime> *getBufferAsVector(void);
